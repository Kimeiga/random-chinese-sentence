...
// (function (global) {
// hankaku <-> zenkaku
export const re_h2z = new RegExp('(?:' + [
    '[',
    '\uFF61\uFF62\uFF63\uFF65\uFF66\uFF67\uFF68\uFF69\uFF6A\uFF6B',
    '\uFF6C\uFF6D\uFF6E\uFF6F\uFF70\uFF71\uFF72\uFF74\uFF75\uFF85',
    '\uFF86\uFF87\uFF88\uFF89\uFF8F\uFF90\uFF91\uFF92\uFF93\uFF94',
...
export const re_z2h = new RegExp('(?:[' + [
    '\u3002\u300C\u300D\u30A1\u30A2\u30A3\u30A4\u30A5\u30A6\u30A7',
    '\u30A8\u30A9\u30AA\u30AB\u30AC\u30AD\u30AE\u30AF\u30B0\u30B1',
    '\u30B2\u30B3\u30B4\u30B5\u30B6\u30B7\u30B8\u30B9\u30BA\u30BB',
    '\u30BC\u30BD\u30BE\u30BF\u30C0\u30C1\u30C2\u30C3\u30C4\u30C5',
...
export const objectReverse = function (o) {
    var r = {};
    for (var p in o) r[o[p]] = p;
    return r;
};
export const o_h2z = objectReverse(o_z2h);
export const f_h2z = function (str) {
    return str.replace(re_h2z, function (m) {
        return o_h2z[m];
    });
};
export const f_z2h = function (str) {
    return str.replace(re_z2h, function (m) {
        return o_z2h[m];
    });
};
// halfwidth <-> fullwidth
export const o_hw2fw = (function (o) {
...
export const re_hw2fw = /[\x21-\x7E\u2985\u2986\xA2\xA3\xAC\xAF\xA6\xA5\u20A9]/g;
export const o_fw2hw = objectReverse(o_hw2fw);
export const re_fw2hw = /[\uFF01-\uFFE6]/g;
export const f_hw2fw = function (str) {
    return str.replace(re_hw2fw, function (m) {
        return o_hw2fw[m];
    });
};
export const f_fw2hw = function (str) {
    return str.replace(re_fw2hw, function (m) {
        return o_fw2hw[m];
    });
};
export const f_fs2hs = function (str) {
    return str.replace(/\u3000/g, ' ');
};
export const f_hs2fs = function (str) {
    return str.replace(/ /g, '\u3000');
};
// katakana <-> hiragana
export const o_h2k = (function () {
    var o = {};
...
export const o_k2h = objectReverse(o_h2k);
export const f_h2k = function (str) {
    return str.replace(/[\u3041-\u3094]/g, function (m) {
        return o_h2k[m];
    });
};
export const f_k2h = function (str) {
